...
for module in cpp_modules:
    ...
    generate_cython_stub_file(PWD+"/"+f"src_python/ldpc/{module}/_{module}.pyx", PWD+"/"+f"src_python/ldpc/{module}/__init__.pyi")
    #generate_cython_stub_file(f"D:\git\CodingTheoryAndCryptography\LDPC_V2.1.0\src_python/ldpc/{module}/_{module}.pyx", f"D:\git\CodingTheoryAndCryptography\LDPC_V2.1.0/src_python/ldpc/{module}/__init__.pyi")

    c_extensions.append(
        Extension(
            name=f"ldpc.{module}._{module}",
            sources=[PWD+"/"+f"src_python/ldpc/{module}/_{module}.pyx"],
            libraries=[],
            library_dirs=[],
            include_dirs=[np.get_include(),'src_cpp', PWD+"/"+'include/robin_map',PWD+"/"+'include/ldpc/src_cpp'],
