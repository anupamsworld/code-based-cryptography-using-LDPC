...
def positionToArray(n, param1):
    param1 = param1.strip().strip('[')
    param1 = param1.strip().strip(']')
    positions = param1.split()
...
with open(fileDir + "message.txt", 'w') as codeword_report_file:
...
positionToArray("""[  15   35   93  100  132  177  208  229  400  469  539  596  682  687
  802  834  879  884 1008 1102 1341 1418 1653 1730 1821 1944 2038 2142
 2146 2169 2181 2257 2285 2438 2457 2461 2511 2519 2620 2724 2747 2782
 2884 2949 2950 2954 3012 3082 3111 3180 3186 3273 3331 3459 3708 3780
 3849 3874 3916 3979 4131 4390 4483 4539 4687 4798 4870 5245 5279 5287
 5348 5601 5739 5788 5985 6022 6055 6167 6219 6358 6383 6400 6414 6463
 6539 6553 6615 6729 6788 6797 6974 7152 7256 7344 7527 7691 7701 7718
 7754 7792 7825 7931 7937 8016 8066 8124]""")
